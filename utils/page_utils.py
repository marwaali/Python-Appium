...
class PageUtils:
    ...
    def switch_to_context(self, webview):
        self.driver.switch_to.context(webview)

    def get_all_contexts(self):
        return self.driver.contexts()

    def wait_clickable(self, locator_type, locator_value, timeout):
        try:
            ...
            raise Exception('Element never became visible: %s (%s)' % (locator_type, locator_value))
